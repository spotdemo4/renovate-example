{
  ...
  inputs = {
    ...
    renovate-main = {
      url = "github:renovatebot/renovate/d572c084410a06607304484b987c3c7745e5a074";
      flake = false;
    };
    renovate-next = {
      url = "git+https://github.com/renovatebot/renovate?ref=next&rev=69f312c16a90dcddeefe73173cd731fad498b88c";
      flake = false;
    };
  };
